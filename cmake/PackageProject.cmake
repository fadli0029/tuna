  ...
  if(NOT
    ...
    foreach(_INC ${_PackageProject_PUBLIC_INCLUDES})
      ...
      if(IS_DIRECTORY ${_INC})
        # the include directories are directly installed to the install destination. If we want an `include` folder in the install destination, name the include directory as `include` (or install it manually using `install()` command).
